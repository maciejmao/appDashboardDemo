...
angular.module("app.controllers", []).controller("AdminAppCtrl", ["$scope", "$location",
    function ($scope, $location) {
        $scope.checkIfOwnPage = function () {
            ...
            var resetpath = (locpath.indexOf('resetpwd/') != -1 ) ? locpath : null;

            return _.contains(["/404", "/pages/500", "/pages/login", "/pages/signin", "/pages/signin/out", "/pages/resetpwd", resetpath, "/pages/signin1", "/pages/signin2", "/pages/signup", "/pages/signup1", "/pages/signup2", "/pages/forgot", "/pages/lock-screen"], $location.path());
        ...
        return lineChart1 = {}, lineChart1.data1 = [
          ...
          [5, 16]
            ...
            tooltipOpts: {
                ...
                '<div class="tooltip-body">%y pkt.</div>',
                shifts: {
                  x: -95,
                  y: 25
                }
